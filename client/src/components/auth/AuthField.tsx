    ...
    <div className="mb-4">
      ...
      >
        <input
          ...
          className={`min-w-0 flex-1 bg-transparent py-3.5 text-[15px] text-slate-900 placeholder:text-slate-400 outline-none focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60 ${className ?? ''}`}
        />
        {trailing}
      </div>
